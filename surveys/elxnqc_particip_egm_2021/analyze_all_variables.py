...
# Variables déjà nettoyées (à skip)
cleaned_vars = ['caseid', 'regio', 'age', 'q1', 'q1x', 'q2', 'q3a', 'q3b', 'q4',
                'q5a', 'q5b', 'q5c', 'q5d', 'q5e', 'q5f', 'q5g', 'q5h', 'q5i']

# Variables techniques à skip
technical_vars = ['popnum', 'qpop', 'qregiz', 'excl', 'q5j_o_m1', 'q5j_o_m2',
                  'q5j_o', 'q5t_m1', 'q5t_m2', 'q5t_m3', 'q5t_m4', 'q5t_m5',
                  'q5t_m6', 'q5t_m7', 'q5t_m8', 'q5t_m9']
...
report = []
report.append("="*80)
report.append("RAPPORT D'ANALYSE DES VARIABLES - elxnqc_particip_egm_2021")
report.append("="*80)
report.append("")
