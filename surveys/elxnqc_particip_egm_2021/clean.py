...
def clean_data(df):
    ...
    # respondent_id - Unique case identifier
    # Source: caseid
    df_clean['respondent_id'] = df['caseid'].copy()

    CODEBOOK_VARIABLES['respondent_id'] = {
        'original_variable': 'caseid',
        'question_label': 'Unique respondent identifier',
        'type': 'numeric',
        'value_labels': {}
    }
    ...
    # ses_age - Age groups
    # Source: age
    # Note: No codebook available, mapping based on typical age group patterns
    ...
    CODEBOOK_VARIABLES['ses_age'] = {
        ...
        'question_label': 'Age group of respondent',
        'type': 'categorical',
        'value_labels': {
            '18-24': '18 à 24 ans',
            '25-34': '25 à 34 ans',
    ...
    # ses_region - Quebec administrative regions
    # Source: regio
    # Note: No codebook available, mapping based on typical Quebec regional divisions
    ...
    CODEBOOK_VARIABLES['ses_region'] = {
        ...
        'question_label': 'Région administrative du Québec',
        'type': 'categorical',
        'value_labels': {
