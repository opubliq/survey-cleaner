...
SURVEY_METADATA = {
    'survey_id': 'elxnqc_particip_egm_2021',           # ID unique du sondage (ex: "ces2019")
    'title': 'Participation EGM 2021',             # Titre complet
    'year': 2021,                          # Année de collecte
    'description': '',                     # Description du sondage
    'organization': '',                    # Organisation responsable
    'sample_size': 3222,                   # Taille de l'échantillon
